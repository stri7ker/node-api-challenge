...
* Status Codes that are sent in the header are used for this. They fall into 5 general categories: 1xx = informational, 2xx = success, 3xx = redirection, 4xx = client error, and 5xx = server error. My favorite is 418.
